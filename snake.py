...
# Difficulté modifiable de 1 à l'infini (non recommandé)
difficulty = 20
...
while True:
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            pygame.quit()
            sys.exit()
        # touche directionnelle classique ou ZSQD
    ...
    # bloquer le changement de direction à l'opposé
